...
class autoScore:
    ...
    def post_content(self):
        ...
        # self.d.send_keys("新春打卡")
        # # 选中内容
        # self.d(resourceId="com.timanetworks.android.faw.vw.aftermarket.release:id/rich_editor_item_edit_text").click()
        # self.d.send_keys("新年快乐 万事如意 诸事顺利 心想事成天天开心 幸福美满 阖家欢乐 福星高照喜上眉梢 欢天喜地 财运亨通 吉祥如意工作顺利 龙马精神 寿比南山 步步高升")
